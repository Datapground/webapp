      ...
      <div className="lg:p-14 md:p-6 p-4">
        <div className="mt-6 border border-[#E5E5E5] rounded-[5px]">
          <div className="lg:px-6 md:px-4 px-3 lg:py-6 md:py-2 py-1.5">
            ...
            <div className="mt-6">
              <button className="lg:px-4 px-3 lg:py-1.5 py-1 lg:text-md text-sm text-white bg-black font-semibold rounded-[5px] flex items-center gap-2">
                <APIKeyIcon className="stroke-[#fff] w-[16px] h-[14px]" />
                Generate API Key
              </button>
              <p className="text-gray-500 font-primary lg:text-sm text-xs mt-2">
                Do not share your API key with anyone. If you believe your API
                key has been exposed to someone else, please refresh to generate
                new API.
              </p>
            </div>
          </div>
